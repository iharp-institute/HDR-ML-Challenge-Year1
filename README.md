...
This data represents buoy hourly sea-level measurements from 12 tide gauge stations along the U.S. East Coast from 1993 to 2013 (for 20 years). Each station's data is a separate time series, labeled with known anomalies.
...
# Test Data
Model submissions are evaluated on a held-out test set spanning 10 years, from 2014 to 2023, for the same coastal stations.
